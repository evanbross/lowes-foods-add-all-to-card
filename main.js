...
function insertButton(btn) {
  function waitForSite() {
    let targetelem = document.getElementById('js-app-content');
	console.log('Button will go before '+targetelem);
    if (targetelem !== null) {
	...
	console.log('insertButton() begin');
...
const observeUrlChange = () => {
	console.log('observeUrlChange begin');
  let oldHref = null;
